Facebook.LikeButton = CLASS({
	...
	init : function(cls, inner, self, params) {'use strict';
		...
		self.setSrc('//www.facebook.com/plugins/like.php?href=' + encodeURIComponent(href) + '&width=' + width + '&height=' + height + '&colorscheme=' + colorscheme + '&layout=' + layout + '&action=' + action + '&show_faces=' + isShowFaces + '&share=' + isShowShareButton + '&appId=' + CONFIG.Facebook.appId);
